  ...
  return (
    <div dir={lang === "fa" ? "rtl" : "ltr"} className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-b from-indigo-100 via-blue-50 to-blue-100 py-10">
      ...
      <div className="flex flex-wrap gap-4 justify-center mb-6">
        ...
        <button
          onClick={toggleMute}
          className="bg-gray-500 hover:bg-gray-600 text-white py-3 px-6 rounded-3xl shadow-md transition-all duration-300 transform font-bold hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
