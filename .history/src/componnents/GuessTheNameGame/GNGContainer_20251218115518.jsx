    ...
    <div dir={lang === "fa" ? "rtl" : "ltr"} className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-b from-indigo-100 via-blue-50 to-blue-100 py-10">
      ...
      {categoryShow && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-md">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700 w-80 sm:w-96 text-center animate-fadeIn">
      ...
      {/* Header */}
      <h1 className="text-4xl md:text-5xl font-extrabold text-indigo-700 dark:text-indigo-400 mb-6 drop-shadow-lg animate-fadeIn" style={{ fontFamily: "Vazirmatn" }}>
        {lang === "en" ? "Guess The Word Game" : "بازی حدس کلمه"}
      </h1>

      {/* Controls */}
      <div className="flex flex-wrap gap-4 justify-center mb-6 animate-fadeIn">
        {!categoryShow && (
          <button
            onClick={handleChangeCategory}
            className="bg-purple-500 hover:bg-purple-600 text-white font-bold py-3 px-6 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-105 text-lg"
        ...
        <button
          ...
          className="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-3xl shadow-md font-semibold transition-all duration-300 transform hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
        ...
        <button
          onClick={selectWord}
          className="bg-emerald-500 hover:bg-emerald-600 text-white py-3 px-6 font-bold rounded-3xl shadow-lg transition-all duration-300 transform hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
        ...
        <button
          onClick={toggleMute}
          className=" bg-gray-500 hover:bg-gray-600 text-white py-3 px-6 rounded-3xl shadow-md transition-all duration-300 transform hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
          {isMuted ? (lang === "en" ? "Unmute" : "با صدا") : (lang === "en" ? "Mute" : "بی‌صدا")}
        </button>
      </div>

      {/* Game Area */}
      {lettersList.length > 0 && (
        <div className="flex flex-col items-center w-full max-w-4xl px-4 sm:px-0 animate-fadeIn">
