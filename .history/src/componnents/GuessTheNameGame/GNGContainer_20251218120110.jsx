      ...
      <div className="flex flex-wrap gap-4 justify-center mb-6">
        {!categoryShow && (
          <button
            ...
            className="cursorbg-purple-500 hover:bg-purple-600 text-white font-bold py-3 px-6 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-105 text-lg"
        ...
        <button
          ...
          className="cursorbg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-3xl shadow-md font-semibold transition-all duration-300 transform hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
        ...
        <button
          onClick={selectWord}
          className="cursorbg-emerald-500 hover:bg-emerald-600 text-white py-3 px-6 font-bold rounded-3xl shadow-lg transition-all duration-300 transform hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
        ...
        <button
          onClick={toggleMute}
          className="cursorbg-gray-500 hover:bg-gray-600 text-white py-3 px-6 rounded-3xl shadow-md transition-all duration-300 transform font-bold hover:scale-105 text-lg"
          style={{ fontFamily: "Vazirmatn" }}
        >
